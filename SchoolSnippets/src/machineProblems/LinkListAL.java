...
public class LinkListAL {
	...
	public static LinkListAL insert(LinkListAL list, int data)
	{
	...
	public static LinkListAL insertCircularList(LinkListAL list, int data)
	{
	...
	public static void printList(LinkListAL list) 
    { 
...
//        System.out.print(": "); 
	...
	public static void printCircularList(LinkListAL list) 
    { 
...
//        System.out.print(": "); 
	...
	public static int queryCircularList(LinkListAL list, int element)
	{
		CircularNode currNode = list.h;
		int counter = 0;
...
//		System.out.println("queried: "+currNode.digit);
	...
	public static void deleteNode(int digit, LinkListAL list)
	{
        if (list.h == null) 
            return; 
	...
	public static int queryList(LinkListAL list, int element)
	{
		SinglyNode currNode = list.head;
		int counter = 1;
...
//		System.out.println("queried: "+currNode.digit);
	...
	public static CircularNode queryNode(LinkListAL list, int element)
	{
		CircularNode currNode = list.h;
		int counter = 1;
...
//		System.out.println("queried: "+currNode.digit);
	...
	static CircularNode findDigit(LinkListAL list, int digit)
	{
		CircularNode currNode = list.h;
